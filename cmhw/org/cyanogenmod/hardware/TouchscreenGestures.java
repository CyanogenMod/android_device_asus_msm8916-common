...
public class TouchscreenGestures {
    ...
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "C", 250),
        new TouchscreenGesture(1, "e", 251),
        new TouchscreenGesture(2, "S", 252),
        new TouchscreenGesture(3, "V", 253),
        new TouchscreenGesture(4, "W", 254),
        new TouchscreenGesture(5, "Z", 24),
    };
