...
public class TouchscreenGestures {
    ...
    private static final TouchscreenGesture[] TOUCHSCREEN_GESTURES = {
        new TouchscreenGesture(0, "C", 265),
        new TouchscreenGesture(1, "e", 266),
        new TouchscreenGesture(2, "S", 267),
        new TouchscreenGesture(3, "V", 263),
        new TouchscreenGesture(4, "W", 268),
        new TouchscreenGesture(5, "Z", 264),
    };
    ...
    public static boolean setGestureEnabled(
        ...
        int gestures = Integer.parseInt(readOneLine(GESTURE_PATH));
	...
	if (gestureMode != 0)
        ...
        return FileUtils.writeLine(GESTURE_PATH, gestures.toString());
    }
}
