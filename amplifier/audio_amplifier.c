...
extern int tfa9887_dualcalibration_startup(void);
extern int tfa9887_dualspeakeron(uint32_t);
extern int tfa9887_dualspeakeroff();
extern int tfa98xx_set_volume(float, float);
extern int tfa98xx_set_vstep(uint32_t, uint32_t);
    ...
    switch (devices) {
        ...
        case SND_DEVICE_OUT_SPEAKER_AND_HEADPHONES:
           if (enable) {
               ...
               tfa98xx_set_vstep(1, 1);
               tfa9887_dualspeakeron(enable);
           } else {
               tfa9887_dualspeakeroff(false);
