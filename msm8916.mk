...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/permissions/asus.hardware.transcover.xml:system/etc/permissions/asus.hardware.transcover.xml \
    $(LOCAL_PATH)/permissions/asus.hardware.transcover_info.xml:system/etc/permissions/asus.hardware.transcover_info.xml \
    $(LOCAL_PATH)/permissions/asus.hardware.transcover_version2.xml:system/etc/permissions/asus.hardware.transcover_version2.xml \
